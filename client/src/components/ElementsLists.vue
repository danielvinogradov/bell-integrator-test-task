...
import ElementsListItem from '@/components/ElementsListItem.vue';
import AppButton from '@/components/AppButton.vue';

@Component({
  components: { ElementsListItem, AppButton },
})
export default class ElementsLists extends Vue {
